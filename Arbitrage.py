...
# Convert liquidity to a graph representation
...
# Adjusting the function to consider Uniswap V2 formula and swap fee
...
# Function to find profitable paths
def find_profitable_path(graph, start_token, starting_amount=5.0, max_depth=4):
    ...
    # If there are profitable paths, select the one with the highest return
    if profitable_paths:
